...
def data_init(tasks):
    ...
    for task in tasks:
        for procedure in ['train', 'test']:
            folder = './data/{}/{}'.format(task, procedure)
...
tasks = ['laptop', 'restaurant', 'device', 'service']
...
PRED_CROSS_PATH = './data/w2v_merge_norm100_10.txt'
CROSS_PATH = './data/cross_domain_word2vec_100d.txt'
