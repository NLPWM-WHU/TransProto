...
parser.add_argument('--tau', default=5, type=int, help='None')
        ...
        for origin in origins:
            for bank in banks:
                ...
                if process != 'test':
                    ...
                    # similarities = (wrd_similarities + dep_similarities + pos_similarities) * indicator
                    # 12.22 (2)
                    if opt.ablation == 'wrd_sim':
                        similarities = (dep_similarities * pos_similarities) * frq_indicator
                    elif opt.ablation == 'pos_sim':
                        similarities = (wrd_similarities * dep_similarities) * frq_indicator
                    elif opt.ablation == 'dep_sim':
                        similarities = (wrd_similarities * pos_similarities) * frq_indicator
                    else:
